class CoinListModel {
  ...
  CoinListModel({this.data});

  factory CoinListModel.fromJson(List<dynamic> parsedJson) {
    List<CoinModel> data = <CoinModel>[];
    data = parsedJson.map((i) => CoinModel.fromJson(i)).toList();
    return new CoinListModel(data: data);
  }
}
